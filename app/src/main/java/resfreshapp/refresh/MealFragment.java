 ...
 */
public class MealFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageButton imgbutton1 =  view.findViewById(R.id.imageButton);
        Button button1 = view.findViewById(R.id.food1_button);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            //Toast.makeText(context,"Meal Fragment Attached", Toast.LENGTH_LONG).show();
        }
    }
